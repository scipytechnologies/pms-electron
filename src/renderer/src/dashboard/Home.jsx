...
export default function Home() {
  ...
  const [salesData, setSalesData] = useState({ dates: [], totalSales: [] })
  const user = useSelector((state) => state.loginedUser)
  const tank = useSelector((state) => state.pumpstore.Tank)
  console.log(tank, 'yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy')

  const fetchData = async (id) => {
    const data = await mainservice.getChart(id) // Make sure this matches your server route
    if (data.data != null) {
      setSalesData(data.data)
    }
  }
  // Function to format the date as "Month day week"
  ...
  // Format the dates
  const formattedDates = salesData.dates.map((date) => formatDate(new Date(date)))
  ...
  const seriesSeven = [
    {
      data: [
        10, 12, 18, 25, 15, 30, 40, 10, 20, 12, 16, 60, 20, 15, 10, 60, 50, 40, 80, 100, 30, 40, 10,
        20, 12, 16, 60, 20, 15, 60, 20, 15, 10, 60, 50, 40, 30, 40, 10, 20, 16, 60, 20, 15, 60, 20,
        15, 10, 60, 50, 40, 30, 40, 10, 20
      ]
    },
    {
      data: [
        -10, -12, -18, -25, -15, -30, -40, -10, -20, -12, -16, -60, -20, -15, -10, -60, -50, -40,
        -80, -40, -30, -40, -10, -20, -12, -16, -60, -20, -15, -60, -20, -15, -10, -60, -50, -40,
        -30, -40, -10, -20, -40, -10, -20, -12, -16, -60, -20, -15, -60, -20, -15, -10, -60, -50,
        -40
      ]
    }
  ]
          ...
          <Col>
            <Card className="card-one">
              <Card.Body className="rounded bg-primary p-3 p-xl-4">
                <h4 style={{ color: 'white' }} className="main-title mb-0">
                  Welcome {user.firstName} {user.lastName} to {pump.PumpName} Management System
                </h4>
                <p style={{ color: 'white', fontSize: '12px', paddingTop: '5px' }}>
                  We are excited to welcome you to our state-of-the-art Petrol Station Management
                  System Dashboard – your all-in-one solution for revolutionizing the way you manage
                  and grow your petrol station business.
                </p>
              </Card.Body>
            </Card>
          </Col>
