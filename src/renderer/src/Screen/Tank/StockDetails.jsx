        ...
        <div className="d-md-flex align-items-center justify-content-between mb-4">
          <div>
            <ol className="breadcrumb fs-sm mb-1">
              ...
              <li className="breadcrumb-item">
                <Link to="/dashboard/DipStock">DipStock</Link>
              </li>
          ...
          <Button
            ...
            onClick={() => navigate('/dashboard/DipStock/dipStock')}
          >
            <i className="ri-bar-chart-2-line fs-18 lh-1"></i>Add DipStock
                    ...
                    <>
                      <ButtonGroup>
                        <Button
                          size="sm"
                          variant="white"
                          onClick={() => handleOpen(item.DipStockId)}
                        >
                        ...
                        <Button className="p-0" variant="white">
                          <Dropdown drop="end">
                            ...
                            <Dropdown.Menu>
                              <Dropdown.Item
                                onClick={() =>
                                  navigate(`/dashboard/DipStock/dipStock/?id=${item.DipStockId}`)
                                }
                              >
                                Edit
                              </Dropdown.Item>
